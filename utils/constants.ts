...
export const resumeUrl: string = "https://raw.githubusercontent.com/DYSLEVIUM/DYSLEVIUM/main/public/Pushpakant%20Behera%20Resume.pdf";
...
export const twitterProfile: string = `https://twitter.com/${twitterUsername}`;
